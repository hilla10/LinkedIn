...
const Post = ({ post }) => {
  ...
  return (
    <div key={post._id} className='bg-secondary rounded-lg shadow mb-4'>
      <div className='p-4'>
        ...
        <div className='px-4 pb-4'>
          ...
          <form onSubmit={handleAddComment} className='flex items-center'>
            <input
              ...
              className='grow p-2 rounded-l-full bg-base-100 focus:outline-none focus:ring-2 focus:ring-primary'
            />
